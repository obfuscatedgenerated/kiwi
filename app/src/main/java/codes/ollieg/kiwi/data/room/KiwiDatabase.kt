...
@Database(entities = [Wiki::class, Article::class], version = 8, autoMigrations = [AutoMigration(from = 1, to = 2), AutoMigration(from = 3, to = 4), AutoMigration(from = 4, to = 5), AutoMigration(from = 6, to = 7), AutoMigration(from = 7, to = 8)])
